...
public class EventFactoryTest {
    ...
    /**
     * Test of getEventList method, of class EventFactory.
     */
    @Test
    public void testGetEventList() {
        System.err.println("getEventList");

        String message = "<cwaEvents>"
                + "<userPresence eid=\"11\">"
        ...
        List expResult = null;
        List result = instance.getEventList(message);

    }
    /**
     * Test of filter method, of class EventFactory.
     */
//    @Test
...
//        List expResult = null;
//        List result = instance.filter(list, type);
